...
def get_dashboard_stats():
    ...
    # Max slots allowed today
    max_slots = get_max_slots(today)
...
def update_booking(booking_id, new_date, new_slot):
    ...
    # ================= DATE-WISE DASHBOARD =================
def get_dashboard_stats_by_date(selected_date):

    conn = get_connection()
    cursor = conn.cursor()

    max_slots = get_max_slots(selected_date)
